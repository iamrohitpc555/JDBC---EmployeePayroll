...
import org.PayrollService.EmployeePayrollData;
...
public class EmployeePayrollDBService {
    ...
    private static DatabaseConnection.EmployeePayrollDBService employeePayrollDBService;

    private EmployeePayrollDBService() {
    }

    public static DatabaseConnection.EmployeePayrollDBService getInstance() {
        if (employeePayrollDBService == null) {
            employeePayrollDBService = new DatabaseConnection.EmployeePayrollDBService();
        }
    ...
    private List<EmployeePayrollData> getEmployeePayrollData(ResultSet result) {
        ...
        try {
            while (result.next()) {
                ...
                employeePayrollList.add(new org.PayrollService.EmployeePayrollData(id, name, Salary, startDate));
            }
        }catch(SQLException e) {
            e.printStackTrace();
        }
    ...
    public org.PayrollService.EmployeePayrollData addEmployeeToPayroll(String name, double salary, LocalDate start, char gender) {
        int employeeId = -1;
        org.PayrollService.EmployeePayrollData employeePayrollData = null;
        ...
        try (Connection connection = this.getConnection()) {
            ...
            employeePayrollData = new org.PayrollService.EmployeePayrollData(employeeId, name, salary, start,gender);
        } catch (SQLException e) {
            e.printStackTrace();
        }
